...
public class EvaluateService {
    ...
    private UserRating CreateUserRating(int movieId, String userId, String rating, MovieDetailEntity movie) {
    ...
    private int EvaluateUpdate(String rating) {
    ...
    private void updateMovieRating(MovieDetailEntity movie, String rating) {
        // 총 평가 퍼센티지 계산 및 업데이트
        if("fresh".equals(rating)) {
